...
/**
 * 「大鹿ニクのリファレンス」で紹介する投稿。
 * 下の配列の末尾に X の投稿 URL を 1 行ずつ追加します。
 * x.com / twitter.com の共有 URL に対応。?s=20 などの末尾はそのままで OK。
 * 配列の順が作品番号です。番号を保つため既存の行は並べ替えません。
 * 画面上の表示順だけ、ページを開くたびにランダムになります。
 * 同じ人の別の投稿も、そのまま追加できます。
...
export const nikuReferencePostUrls: string[] = [
	...
	'https://x.com/The_YokaiTake/status/2098669771755770149',
	'https://x.com/TK2Works/status/2098596616517394759',
];
